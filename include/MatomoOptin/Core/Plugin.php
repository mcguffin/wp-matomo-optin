...
class Plugin extends PluginComponent {
	...
	public function maybe_upgrade() {
		...
		$old_version = get_site_option( 'matomo_optin_version' );
		...
		if ( version_compare($new_version, $old_version, '>' ) ) {
			...
			update_site_option( 'matomo_optin_version', $new_version );
	...
	public function load_textdomain() {
		...
		load_plugin_textdomain( 'wp-matomo-optin', false, $path . '/languages' );
	}
